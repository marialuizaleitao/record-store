...
-- 5. GET ALL THE BANDS THAT HAVE NO ALBUMS
...
VALUES ('Rumours', 1977, 8);

-- 9. DELETE THE BAND AND ALBUM ADDED PREVIOUSLY 
DELETE FROM albums
WHERE id = 19;
DELETE FROM bands
WHERE id = 8;

-- 10. GET THE AVERAGE LENGHT OF ALL SONGS
